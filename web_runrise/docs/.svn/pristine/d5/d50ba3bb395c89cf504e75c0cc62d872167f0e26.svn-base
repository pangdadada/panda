...
<p><img src="https://cdn.staticaly.com/gh/xugaoyi/image_store/blog/20200103124306.png" alt="主动提交"></p>
<p>具体使用方法就是创建一个文件<code v-pre>urls.txt</code>，文件内每行一条链接的格式写入提交的多个链接，如图。</p>
<p><img src="https://cdn.staticaly.com/gh/xugaoyi/image_store/blog/20200103124305.png" alt="urls.txt"></p>
<p>运行命令</p>
